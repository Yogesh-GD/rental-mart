...
import { addLicenseDetails, getUserProfile, updateLicenseDetails } from "../../slices/User/userSlice";
...
console.log(status)
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(addLicenseDetails(formData));
  };
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6">
      <h2 className="text-3xl font-bold text-center mb-6">Add Driving License</h2>
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-[#212121] p-6 rounded-lg shadow-md space-y-4">
        ...
        >
          {status === "submitting" ? "Uploading..." : status === "succeed" ? "Uploaded" : <><FaSave className="mr-2" /> Save Changes</>}
        </button>
